<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrdersPage.aspx.cs" Inherits="TechFix.TechFix_Pages.OrdersPage" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container mt-5">
            <div class="order-card text-center">
                <b><asp:Label ID="lblOrderNumber" runat="server" Text="Order Number: 0001" Font-Size="Large" /></b><br />
        ...
        <div class="container mt-5">
            <div class="order-card text-center">
                <b><asp:Label ID="Label1" runat="server" Text="Order Number: 0001" Font-Size="Large" /></b><br />                <asp:Label ID="lblOrderName2" runat="server" Text="Order Name: PRIME X299-DELUXX II" Font-Size="Medium" /><br />
